...
|¿Por qué llevar a cabo este análisis? |El objetivo del siguiente análisis competitivo es identificar las fortalezas y debilidades de EduFocus que es el producto final de TechNest en relación con los posibles competidores para desarrollar estrategias efectivas para tener ventaja competitiva en el mercado.|
|--|--|
---
|Competidores |<a  href ="https://postimg.cc/N960TL47"><img  src="https://i.postimg.cc/mDq1vH1q/logo.png"  alt="Logo EduFocus"  width="4000"  height="100" /></a> |<a  href ="https://postimg.cc/zV17ZTrj"><img  src="https://i.postimg.cc/Kv1HT5pd/logo-competidor2.png"  alt="Logo Terapify"  width="4000"  height="100"></a> |<div  style="background: black;"><a  href ="https://postimg.cc/G4Lj9r9T"><img  src="https://i.postimg.cc/QxRYyCpJ/Realizate.png"  alt="Logo Realizate"  width="5000"  height="100"></a></div> |<a  href ="https://postimg.cc/hfbrSh4q"><img  src="https://i.postimg.cc/5NDkSFZj/logo-competidor3.png"  alt="Logo Mentoring"  width="5000"  height="100"></a> |
|--|--|--|--|--|
|**Perfil**|||||
|Overview|Aplicación web y móvil|Aplicación web|Aplicación web|Aplicación web|
|Ventaja competitiva ¿Qué valor ofrece al cliente?|Permite encontrar un espacio agradable en el cual los estudiantes puedan ser ayudados por expertos en diferentes áreas como la educación o psicología y pueden seguir su progreso con actividades que los expertos les puedan brindar. |Permite obtener la estabilidad emocional que necesitan las personas en su vida diaria con un psicólogo online.| Plataforma que nace con el propósito de ayudar a mejorar la calidad de vida a través de un nuevo concepto de productividad, además, brinda diferentes talleres sobre hábitos, productividad, etc.| Permite buscar profesionales de cualquier temática y contrátalos para que ayuden a la persona y guíen de forma personalizada y totalmente privada, además, ofrece la opción de que un experto ofrezca su servicio.|
| **Perfil de Marketing** | | | | |
|Mercado objetivo | Estudiantes de educación superior y Cualquier persona interesada. |Cualquier persona interesada. |Cualquier persona interesada. |Cualquier persona interesada. |
|Estrategias de marketing |Publicidad en redes sociales. <br><br> Colaboraciones con personas influyentes para promocionar el producto.|Publicidad en redes sociales. |Publicidad en redes sociales. |Publicidad en redes sociales |
|**Perfil del Producto** | | | | |
|Productos & Servicios |Proporciona profesionales en educación o psicología para ayudar a los estudiantes para obtener un desempeño académico destacado. |Proporciona profesionales en psicología para resolver diversos problemas de manera personalizada del cliente. |Proporciona profesionales en educación, ingeniería, etc., para resolver diversos problemas sobre productividad, hábitos y organización de manera personalizada al cliente. |Proporciona profesionales en una gran variedad de temas como desarrollo web, marketing, etc., para ayudar a un publico estudiantil o profesional a entender o mejorar en algunos temas específicos. |
|Precios & Costos |Usuarios: Plan Básico: S/. 30 Plan Standard: S/. 120 Plan Premium: S/. 200 | Cita de orientación: S/. 0 Cita individual: S/. 140 Cita de pareja: S/. 180 | Depende del paquete de asesorías que se desee y se le agrega un impuesto al costo final|Depende de cada especialista, ya que el cobro es por hora. |
|Canales de distribución (Web y/o Móvil) |Web/Móvil |Web |Web |Web |
|Tecnologías usadas |Angular, CSS3, JavaScript y HTML5 | CSS3, JavaScript y HTML5 |CSS3, JavaScript y HTML5 | CSS3, JavaScript y HTML5 |
|**Análisis SWOT** | | | | |
|Fortalezas |Seguridad, confianza, calidad, garantía, los clientes ahorraran y tendrán grandes resultados al final de sus talleres, asesorías o mentorías. |Proporciona gran variedad de psicólogos especializados |Proporciona varios talleres de productividad y organización |Proporciona varios módulos de estudio. |
|Debilidades |Poca experiencia en el mercado. |Los precios son altos para la duración de 1 cita de 50 minutos. |Precios altos por cada módulo presentado y aparte se le agrega un impuesto. |Precios variables pero por hora. |
...
- ¿Utilizas alguna técnica o hábito de estudio para retener mejor la

información?

- ¿Cómo manejas los momentos de estrés durante las fechas de exámenes o

entrega de proyectos?

- ¿Has recibido apoyo de personas cercanas a ti que te ayuden en tus

estudios?

- ¿Tienes amigos con los que haces grupo de estudio en alguna materia?

- ¿Sientes que necesitas mejorar para alcanzar un rendimiento académico

más sólido?

- ¿Te encuentras satisfecho con el equilibrio entre tu vida académica y

personal?

  

- ¿Qué aspectos de tu bienestar emocional o psicológico podrían afectar

a tu desempeño académico?

  

- ¿Has tomado alguna medida o has encontrado un espacio para poder

solucionar algunos de estos problemas que ocurren durante la vida

académica?

  

- ¿Has usado herramientas digitales o aplicaciones para encontrar la
...
**Preguntas principales:**
- En tu experiencia trabajando con estudiantes universitarios, ¿cuáles
son los desafíos más comunes que observas en términos de rendimiento
académico y bienestar en general?

- ¿Cómo crees que tus habilidades y conocimientos podrían ser beneficiosos para ayudar a los estudiantes a superar estos desafíos y
tener éxito en sus estudios?

- ¿Cuál es tu forma de trabajo con los estudiantes o que es lo que
realizas en tus sesiones generalmente?

- ¿Has trabajado anteriormente en entornos virtuales o en línea? Si es
así, ¿qué herramientas has encontrado más efectivos para mantener una
comunicación significativa con los estudiantes?

- ¿Qué indicadores considerarías para evaluar el progreso de los
estudiantes que reciben tu ayuda?

  

#### 2.2.2. Registro de entrevistas

Gráfico 4: Entrevista 1 a estudiante
...
- ¿De qué distrito eres?
Vivo en el distrito de Villa el Salvador

 
**Preguntas principales:**

- ¿Cómo crees que ha sido tu rendimiento académico hasta ahora?
Siento que mi rendimiento académico ha mejorado en el último año, con resultados más satisfactorios en mis calificaciones. La organización ha sido clave para ello.

- ¿Cómo te organizas para estudiar diferentes materias?
Me organizo utilizando una agenda y Google Calendar para programar mis horarios de clase, trabajo y actividades diarias. Esto me ayuda a administrar mi tiempo de manera efectiva.

- ¿Utilizas alguna técnica o hábito de estudio para retener mejor la información?
Me gusta resumir, hacer apuntes y destacar información importante. En general, resumir y escribir me ayudan a estudiar de manera más efectiva.

- ¿Cómo manejas los momentos de estrés durante las fechas de exámenes o entrega de proyectos?
Cuando siento estrés, trato de relajarme y motivarme a mí misma. Escucho música y me doy ánimos para mantener la concentración. Además, evito estudiar profundamente antes de los exámenes y prefiero hacer repasos.

- ¿Has recibido apoyo de personas cercanas a ti que te ayuden en tus estudios?

Principalmente, no. En mi caso, tiendo a estudiar de manera autodidacta y buscar ayuda solo cuando tengo dudas significativas.

- ¿Tienes amigos con los que haces grupo de estudio en alguna materia?
Solía estudiar en grupos pequeños, pero actualmente, debido a mi trabajo y horarios ajustados, prefiero estudiar sola, ya que me concentro mejor.

- ¿Sientes que necesitas mejorar para alcanzar un rendimiento académico más sólido?
Creo que puedo mejorar en el aspecto de realizar repasos constantes y priorizar mejor mis estudios. A veces, olvido ciertos conceptos porque no repaso con la frecuencia necesaria.

- ¿Te encuentras satisfecho con el equilibrio entre tu vida académica y personal?
En general, me siento satisfecha con el equilibrio entre mi trabajo y mis estudios.

- ¿Qué aspectos de tu bienestar emocional o psicológico podrían afectar a tu desempeño académico?
El entorno externo, como un trabajo anterior desafiante, ha influido en mi rendimiento académico en el pasado. El ambiente laboral y la presión pueden afectar el desempeño académico.
...
Busqué asesoramiento de una psicóloga para lidiar con desafíos laborales y busqué testimonios en línea para encontrar respuestas a mis inquietudes.
...
**Usuario estudiante:** El User Persona del estudiante refleja a individuos jóvenes que buscan constantemente mejorar su rendimiento académico y su bienestar emocional durante su educación superior. Se esfuerzan por organizarse mejor, adquirir técnicas de estudio efectivas y manejar el estrés. A pesar de su determinación, a menudo se sienten abrumados por la presión académica y la falta de recursos para abordar sus desafíos. 
